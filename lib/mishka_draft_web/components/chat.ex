defmodule MishkaDraftWeb.Components.Chat do
  @moduledoc """
  `MishkaDraftWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
