defmodule MishkaDraftWeb.Components.MegaMenu do
  @moduledoc """
  The `MishkaDraftWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
