defmodule MishkaDraftWeb.Components.ScrollArea do
  @moduledoc """
  The `MishkaDraftWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
