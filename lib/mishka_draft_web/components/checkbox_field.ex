defmodule MishkaDraftWeb.Components.CheckboxField do
  @moduledoc """
  MishkaDraftWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
