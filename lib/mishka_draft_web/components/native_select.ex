defmodule MishkaDraftWeb.Components.NativeSelect do
  @moduledoc """
  The `MishkaDraftWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `MishkaDraftWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MishkaDraftWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MishkaDraftWeb.Gettext, "errors", msg, opts)
    end
  end
