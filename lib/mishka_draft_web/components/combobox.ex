defmodule MishkaDraftWeb.Components.Combobox do
  @moduledoc """
  The `MishkaDraftWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
  ...
  use Gettext, backend: MishkaDraftWeb.Gettext
