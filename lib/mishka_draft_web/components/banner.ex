defmodule MishkaDraftWeb.Components.Banner do
  @moduledoc """
  MishkaDraftWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
