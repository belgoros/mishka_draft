defmodule MishkaDraftWeb.Components.CheckboxCard do
  @moduledoc """
  The `MishkaDraftWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
