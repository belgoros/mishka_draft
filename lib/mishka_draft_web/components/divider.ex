defmodule MishkaDraftWeb.Components.Divider do
  @moduledoc """
  The `MishkaDraftWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `MishkaDraftWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
