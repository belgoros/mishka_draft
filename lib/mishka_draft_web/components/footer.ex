defmodule MishkaDraftWeb.Components.Footer do
  @moduledoc """
  The `MishkaDraftWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
