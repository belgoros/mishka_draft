defmodule MishkaDraftWeb.Components.Menu do
  @moduledoc """
  The `MishkaDraftWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `MishkaDraftWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import MishkaDraftWeb.Components.Accordion, only: [accordion: 1]
  import MishkaDraftWeb.Components.Button, only: [button_link: 1]
