defmodule MishkaDraftWeb.Components.Tabs do
  @moduledoc """
  `MishkaDraftWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import MishkaDraftWeb.Components.Badge, only: [badge: 1]
