defmodule MishkaDraftWeb.Components.Indicator do
  @moduledoc """
  The `MishkaDraftWeb.Components.Indicator` module provides a versatile component for visually highlighting
