defmodule MishkaDraftWeb.Components.TableContent do
  @moduledoc """
  `MishkaDraftWeb.Components.TableContent` is a component module designed to create flexible and dynamic
