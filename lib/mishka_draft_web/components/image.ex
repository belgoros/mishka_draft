defmodule MishkaDraftWeb.Components.Image do
  @moduledoc """
  The `MishkaDraftWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
